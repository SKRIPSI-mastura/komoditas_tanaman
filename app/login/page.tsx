...
{/* To show, remove 'hidden' class */}
<div className="hidden mb-6 p-4 rounded-xl bg-error-container border-l-4 border-error flex items-start gap-3 transition-all duration-300">
...
<p className="text-xs text-on-error-container/80">Kredensial yang Anda masukkan tidak terdaftar di sistem kami.</p>
</div>
<button className="text-on-error-container/50 hover:text-on-error-container">
...
<input className="w-full pl-12 pr-4 py-4 bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-primary/40 text-on-surface placeholder:text-outline/60 transition-all" id="username" name="username" placeholder="Masukkan username admin" type="text" />
</div>
</div>
{/* Password Input */}
<div className="space-y-2">
...
<input className="w-full pl-12 pr-4 py-4 bg-surface-container-low border-none rounded-xl focus:ring-2 focus:ring-primary/40 text-on-surface placeholder:text-outline/60 transition-all" id="password" name="password" placeholder="••••••••" type="password" />
